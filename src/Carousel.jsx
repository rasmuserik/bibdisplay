...
function materialIcon(work) {
  ...
  if (type.match(/e-bog/i) || type.match(/bog.*online/i))
    return "icons/ebook.webp";
  if (type.match(/gameboy|nintendo|computerspil|playstation|psp|wii|xbox/i))
    return "icons/play.webp";
  ...
  return (
    <>
      ...
      >
        {showcase &&
          (!showcase.expires ||
            showcase.expirydate >= new Date().toISOString().split("T")[0]) && (
            <div
              style={{
